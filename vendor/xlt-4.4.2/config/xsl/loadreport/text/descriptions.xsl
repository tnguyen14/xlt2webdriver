...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template name="description-summary">
        <div class="description">
            <p>
                To help you evaluate the test results quickly and easily, this table gathers general performance characteristics: the
                traffic volume the test created, the number of errors and events, and runtime numbers.
            </p>
        </div>
    </xsl:template>
    ...
    <xsl:template name="description-external">
        <div class="description">
            <p>
                This section shows external data. Please see the manual on how to configure and write your own reports.
            </p>
        </div>
    </xsl:template>
    ...
    <xsl:template name="description-error-summary">
        <div class="description">
            ...
            <div id="more-{$gid}" class="more">
                ...
                <p>
                    The Overview below lists the error message and the count. It ignores the stack trace to sum up common
    ...
    <xsl:template name="description-event-summary">
        <div class="description">
            ...
            <p>
                The table below shows all events that occurred during the load test. Events are used to indicate that the test
            ...
            <div id="more-{$gid}" class="more">
                ...
                <p>
                    The Events table lists the affected URLs (if available) next to the events to allow for fast debugging.
                </p>
            </div>
        </div>
    </xsl:template>
